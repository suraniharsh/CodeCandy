...
export function EditSnippetForm({ onSuccess, onCancel,snippet, collectionId: initialCollectionId }: EditSnippetFormProps) {
  ...
  const [selectedCollectionId, setSelectedCollectionId] = useState(initialCollectionId || snippet.collectionId || '');
  ...
  const handleSubmit = async (e: FormEvent) => {
    ...
    try {
      ...
      console.log('updating snippet with collection:', selectedCollectionId);
      const snippetData = {
        title,
        description,
        code,
        language,
        tags,
        collectionId: selectedCollectionId || snippet.collectionId || undefined,
        isFavorite: false,
        id:snippet.id,
      ...
      await snippetService.updateSnippet(snippetData);
